...
MODULE DEBUGMOD
  ...
  ! Each subroutine, defined in the insize ofterface "DEBUG" has 4 inputs:
...
PROGRAM EX3
  ...
  open(1,file="time1.txt",status='old',action='write',position="append")
  open(2,file="time2.txt",status='old',action='write',position="append")
  open(3,file="time3.txt",status='old',action='write',position="append")
  open(4,file="time4.txt",status='old',action='write',position="append")
